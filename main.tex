...
\singlespace \input{titlepage} \doublespace
\pagebreak
...
\input{introduction}
\input{chapters/2_coop_policies}
\input{chapters/3_one_step}
\input{chapters/4_absorb_markov}
\input{chapters/5_simulations}
