...
\begin{equation} \label{eq:oneOutProb}
	S_T = \frac{1}{v}\int_{-\alpha_2}^{\alpha_1} r_{11} \frac{1}{2\pi} e^{-\lambda \pi r_{\!_{11}}^2} d\alpha +  \frac{1}{v}\int^{2\pi-\alpha_2}_{\alpha_1}r_{12} \frac{1}{2\pi} e^{-\lambda \pi r_{\!_{12}}^2} d\alpha
\end{equation} \\
Where
\begin{align*}
