...
\section{Downlink Cooperation Policy}
...
\begin{figure}[h]
	...
	\vspace{-10pt} \caption[Effect of the proximal Operator]{\small Effect of the Proximal Operator }
	\label{fig:dwnlink}
\end{figure}
...
\begin{figure}[h]
	...
	\vspace{-5pt} \caption[Effect of the proximal Operator]{\small Effect of the Proximal Operator }
	\label{fig:region}
\end{figure}
